...
public class DisciplineNameColumnPredicateFactory extends PredicateFactory {
    @Override
    ...
    private Predicate<LabWork> createMorePredicate(String value){
        return (labwork) -> labwork.getDiscipline()!= null && labwork.getDiscipline().getName().compareTo(value)>0;
    }
    ...
    private Predicate<LabWork> createEqualPredicate(String value){
        return (labwork) -> labwork.getDiscipline()!= null && labwork.getDiscipline().getName().equals(value);
    }
